      ...
      <div className="glass-panel max-w-md w-full p-8 rounded-[2.5rem] relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleAuth} className="space-y-5" noValidate>
            <div>
              <label htmlFor="auth-email" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">E-mail</label>
              <input 
                id="auth-email"
                name="email"
                type="email" 
            ...
            <div>
              <label htmlFor="auth-password" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Senha</label>
              <input 
                id="auth-password"
                name="password"
                type="password" 
